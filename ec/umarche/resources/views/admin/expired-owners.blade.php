                        ...
                        <div class="container px-5 mx-auto">
                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                                ...
                                <tr>
                                    ...
                                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">期限偽切れ日</th>
                                ...
                                <tr>
                                    ...
                                    @method('delete')
                                    <td class="px-4 py-3">
                                    <a href="#" data-id="{{$owner->id}}" onclick="deletePost(this)">完全に削除する</a>
                                    </td>
                                    </form>
                                </tr>
                                @endforeach
                            ...
                            <button class="" onclick="location.href='{{route('admin.owners.create')}}'">新規登録する</button>
                        </div>
                    </section>
                    <br>
                </div>
